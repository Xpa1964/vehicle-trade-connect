...
export function useConversationData(userId: string | undefined) {
  ...
  // Fetch conversations list - CORREGIDO para mostrar conversaciones de anuncios
  const fetchConversations = useCallback(async () => {
    ...
    try {
      ...
      // Cambiado de vehicles!inner a vehicles para usar LEFT JOIN
      ...
      // Format conversations with vehicle info - manejando casos sin vehículo
      const formattedConversations: Conversation[] = data.map(conv => {
        // Solo formatear vehicle_info si existe un vehículo
  ...
  // Load full conversation details with messages - SIN CAMBIOS
  ...
  // Get conversation source information - MEJORADO para anuncios
  const getConversationSource = useCallback(async (conversation: Conversation): Promise<ConversationSource | null> => {
    ...
    try {
      ...
      // Si es una conversación de anuncio - MEJORADO
