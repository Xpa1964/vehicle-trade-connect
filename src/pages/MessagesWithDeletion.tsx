      ...
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div className="hidden lg:grid lg:grid-cols-3 gap-4 p-4 flex-1 min-h-0" style={{ isolation: 'isolate' }}>
          ...
          <div className="lg:col-span-1 min-h-0 flex flex-col relative z-10">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 flex-1 flex flex-col min-h-0 relative" style={{ overflow: 'visible', zIndex: 10 }}>
          ...
          {/* Área de chat */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 lg:col-span-2 flex flex-col min-h-0 relative z-0" style={{ zIndex: 0 }}>
