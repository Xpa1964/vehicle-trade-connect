        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {recommendedVehicles.slice(0, 4).map((vehicle) => (
            <div
              ...
              className="group cursor-pointer bg-secondary rounded-lg border border-border overflow-hidden hover:border-primary/30 hover:shadow-lg transition-all duration-200"
            >
